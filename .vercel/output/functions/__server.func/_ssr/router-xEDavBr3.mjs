...
const appCss = "/assets/styles-BUPbOsQK.css";
...
const $$splitComponentImporter = () => import("./index-Cr7sr6Bo.mjs");
const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Treinamento prático para médicos: via aérea, ventilação, procedimentos e decisão sob pressão. Domine a sala vermelha antes do próximo plantão."
    }, {
      property: "og:title",
      content: "Domine a Sala Vermelha | EmergPapers"
    }, {
      property: "og:description",
      content: "De médico inseguro a médico resolutivo. Treinamento de elite em emergências reais."
    }]
  })
});
